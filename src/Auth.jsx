...
function Logo() {
  const bW=220,bH=136,gap=9,labW=38,tot=bW+gap+labW,sc=0.42
  ...
  return (
    <svg width={tot*sc} height={bH*sc} viewBox={`0 0 ${tot} ${bH}`}
      ...
      <text x={bW/2} y={bH*0.73} textAnchor="middle"
        ...
        fontWeight="900" fontSize="84" letterSpacing="12" fill={C.green}>R F P</text>
      <text x={labCX} y={labCY} textAnchor="middle" dominantBaseline="central"
        fontFamily="'Barlow Condensed','Arial Black',Impact,Arial,sans-serif"
        fontWeight="900" fontSize="24" letterSpacing="6" fill={C.black}
